...
public class ReporteConciliacionWompiReproceso {
	...
	public static void main( String[] args )
	{
		...
		for(int j = 0; j < tiendas.size(); j++)
		{
			...
			for(int k = 0; k < pedVirtualTienda.size(); k++)
			{
				...
				//Se hace necesario realizar una diferenciaci�n con el pago de Bancolombia que cobra menos
		...
		//Extraemos una informaci�n para sacar resumen de los pagos por tarjeta
		...
		respuesta = respuesta + "</table><br/>";
		//Incluiremos la informaci�n del QR Bancolombia
		//valor de comisi�n QR Bancolombia
		...
		respuesta = respuesta + "<tr>"
				+  "<td><strong>Nombre Tienda</strong></td>"
				+  "<td><strong>Valor Dinero</strong></td>"
				+  "<td><strong>Valor Comisi�n</strong></td>"
				+  "</tr>";
		...
		//Incluiremos la informaci�n de pago de TARJETAS REGALO PIZZA AMERICANA
		...
		correo.setAsunto("CONCILIACI�N SEMANAL PAGOS VIRTUALES - PAGOS CON TARJETA DESDE " + fechaAnterior + " HASTA "  + fechaActual);
		correo.setContrasena(infoCorreo.getClaveCorreo());
		ArrayList correos = GeneralDAO.obtenerCorreosParametro("REPORTECONCILIACIONWOMPI");
		correo.setUsuarioCorreo(infoCorreo.getCuentaCorreo());
		correo.setMensaje("A continuaci�n el detalle y resumen de los pedidos con forma de pago virtual entre las fechas " + fechaAnterior + " - " + fechaActual +  ": \n" + respuesta);
