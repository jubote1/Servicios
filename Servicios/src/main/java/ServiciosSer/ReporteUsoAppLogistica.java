 ...
 *
 */
public class ReporteUsoAppLogistica {
...
{
	ReporteUsoAppLogistica reporteUsoApp = new ReporteUsoAppLogistica();
...
public void generarUsoApp()
{
	...
	String respuesta = "";
	respuesta = respuesta + "<table border='2'> <tr> REPORTE DE USO APP LOGÍSTICA  " + fechaActual + " </tr>";
