...
public class ReporteConsignacionWompi {
	...
	public static void main( String[] args )
	{
		...
		//El proceso realizar� proceso siempmre y cuando sea festivo
		int diaControl = 0;
		...
		if(!hoyEsFestivo)
		{
			...
			while(controlador)
			{
				//Restamos de a d�a partiendo de la fecha actual
			...
			String respuesta = "";
			respuesta = respuesta + "<table border='2'> <tr> <td colspan='6'> RESUMEN GENERAL PARA CONSIGNACI�N DE WOMPI ENTRE " + fechaAnterior + "  " + fechaActual + " </td></tr>";
			...
			correo.setMensaje("A continuaci�n el detalle DE LA CONSIGNACI�N QUE REALIZAR� WOMPI por los pedidos con forma de pago virtual entre las fechas " + fechaAnterior + " - " + fechaActual +  ": \n" + respuesta);
