...
public class ReporteSemanalDetalladoDIDI {
	...
	public void generarReporteDomiciliosCOM()
	{
		...
		for(int i = 0; i < razonesSociales.size(); i++)
		{
			...
			ArrayList pedidosDomCOM = PedidoDAO.obtenerPedidosPlataformas(razTemp.getIdRazon(), fechaAnterior, fechaActual,1);
			//Obtenemos un total por tienda de los pedidos
			ArrayList pedidosDomCOMTienda = PedidoDAO.obtenerPedidosPlataformasTienda(razTemp.getIdRazon(), fechaAnterior, fechaActual,1);
			...
			//Obtenemos totales de pago online por tienda
			ArrayList descuentosDomCOMTienda = PedidoDAO.obtenerDescuentosPlataformasTienda(razTemp.getIdRazon(), fechaAnterior, fechaActual,1);
			//Procedemos a procesar la información y a enviar el correo con el reporte
			String respuesta = "";
			respuesta = respuesta + "<table border='2'> <tr> RESUMEN SEMANAL DIDI RAZON SOCIAL " + razTemp.getNombreRazon() +  " </tr>";
			...
			respuesta = respuesta + "<table border='2'> <tr> RESUMEN SEMANAL POSIBLES ANULACIONES DIDI RAZON SOCIAL " + razTemp.getNombreRazon() +  " </tr>";
			respuesta = respuesta + "<tr>"
			...
			respuesta = respuesta + "<table border='2'> <tr> RESUMEN SEMANAL POSIBLES CAMBIO DE PEDIDO DIDI RAZON SOCIAL " + razTemp.getNombreRazon() +  " </tr>";
			respuesta = respuesta + "<tr>"
					+  "<td><strong>ID Pedido Contact</strong></td>"
					+  "<td><strong>Num PosHeader</strong></td>"
					+  "<td><strong>Fecha Pedido</strong></td>"
			...
			correo.setAsunto("Reporte Semanal DIDI de la Razón Social " + razTemp.getNombreRazon() + " " + razTemp.getIdentificacion());
...
{
	ReporteSemanalDetalladoDIDI reporteDomicios = new ReporteSemanalDetalladoDIDI();
