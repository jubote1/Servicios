 ...
 *
 */
public class ReportePromocionesDiariasReproceso {
...
{
	ReportePromocionesDiariasReproceso reportePromoDiarias = new ReportePromocionesDiariasReproceso();
...
public void generarInfoPromociones()
{
	...
	respuestaExtraCompartir = respuestaExtraCompartir + "<tr><td> TOTAL CONTACT </td><td>" + formatea.format(PedidoDAO.obtenerTotalesPromo(strFechaActual, 29, "C")) + "</td></tr>";
	respuestaExtraCompartir = respuestaExtraCompartir + "<tr><td> TOTAL TIENDA VIRTUAL PROMO</td><td>" + formatea.format(PedidoDAO.obtenerTotalesPromo(strFechaActual, 29, "T") + PedidoDAO.obtenerTotalesPromo(strFechaActual, 29, "TK") ) + "</td></tr>";
