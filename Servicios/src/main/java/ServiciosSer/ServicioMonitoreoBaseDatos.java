...
public void monitorearBaseDatos()
{
	...
	String respuesta = "";
	int cantidadConexiones = TiendaDAO.obtenerCantidadConexionesBD();
	//Realizamos el env�o del correo electr�nico con los archivos
	if(cantidadConexiones  >= 20)
	{
		Correo correo = new Correo();
		correo.setAsunto("URGENTE ACCIÓN BASE DE DATOS " + fechaActual.toString());
		...
		String mensaje = "Cuidado, nuestra base de datos principal tiene un número de conexiones activas  de " + cantidadConexiones;
