...
public class ReporteSemanalContactCenterReproceso {
	        ...
	        
	{
		...
		//Realizamos la inserción de los valores para la reporteria
		...
		//Vamos a agregar la l�gica para el tema de tickets promedio
