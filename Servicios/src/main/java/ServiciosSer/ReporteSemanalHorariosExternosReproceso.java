...
public class ReporteSemanalHorariosExternosReproceso {
		...
		try
		{
			 ...
			 //Creamos el estilo para el nombre del reporte
			   ...
			   //Instanciamos la respuesta ArrayList
				...
				ArrayList<EmpleadoEvento>  repEntradasSalidas = ReporteHorariosDAO.obtenerEntradasSalidasEmpleadosExternosEventos(fechaAnterior,fechaActual);
			...
			correo.setAsunto("GENERAL CUMPLIMIENTO DE HORARIOS EMPLEADOS-EXTERNOS SEMANAL DE " + fechaAnterior + " HASTA " + fechaActual);
