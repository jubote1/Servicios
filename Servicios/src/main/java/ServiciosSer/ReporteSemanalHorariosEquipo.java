		...
		try
		{
			 ...
			 //Creamos el estilo para el nombre del reporte
			   ...
			   //Instanciamos la respuesta ArrayList
				...
				ArrayList<EmpleadoEvento>  repEntradasSalidas = ReporteHorariosDAO.obtenerEntradasSalidasEmpleadosInternosMiosEventos(fechaAnterior,fechaActual);
			...
			ArrayList correos = GeneralDAO.obtenerCorreosParametro("REPORTEHORASEQUIPO");
			Date fecha = new Date();
			Correo correo = new Correo();
			CorreoElectronico infoCorreo = ControladorEnvioCorreo.recuperarCorreo("CUENTACORREOREPORTES", "CLAVECORREOREPORTE");
			correo.setAsunto("GENERAL CUMPLIMIENTO DE HORARIOS EQUIPO TECNOLOGIA Y MERCADEO SEMANAL DE " + fechaAnterior + " HASTA " + fechaActual);
			...
			correo.setAsunto("GENERAL PERSONAS TECNOLOGIA Y MERCADEO Y MOMENTOS DE NO USO DEL HUELLERO DACTILAR DE " + fechaAnterior + " HASTA " + fechaActual);
