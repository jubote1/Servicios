...
public class ReporteResumenVentasCierreFacturaElectronica {
	...
	public void generarReporte()
	{
		...
		if(diaMaximoMesActual == diaActual)
		{
			...
			correo.setMensaje("A continuaci�n el reporte Mensual de cantidad de pedidos " + fechaAnterior + " - " + fechaActual +  ": \n" + respuestaCantFacturas);
			...
			respuesta = respuesta + "<tr><td>TOTAL VENTA CON DAT�FONO</td><td>" + formatea.format(ventaTotalTarjetaMes) + "</td></tr>";
			respuesta = respuesta + "</table><br/>";
			...
			//Vamos a agregar la l�gica para la generaci�n de los tickets promedios
			...
			correo.setUsuarioCorreo(infoCorreo.getCuentaCorreo());
			correo.setMensaje("A continuaci�n el reporte Mensual de ventas entre las fechas " + fechaAnterior + " - " + fechaActual +  ": \n" + respuesta);
...
{
	ReporteResumenVentasCierreFacturaElectronica reporteDomicios = new ReporteResumenVentasCierreFacturaElectronica();
