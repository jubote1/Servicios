...
public void generarPromociones()
{
	...
	System.out.println("EMPEZAMOS LA EJECUCI�N PROCESO DE PROMOCIONES");
	...
	//Realizamos el recorrido de esta promoci�n con el fin de realizar las actividades por cada promoci�n
	for(int i = 0; i < tiendaCodPromos.size(); i++)
	{
		...
		respuesta = respuesta + " <p> Id Tienda enviada " + tiendaCodTemp.getIdTienda() + " EXITOSO con " + codPromosTemp + " c�digos." + " </p>";
	}
	//Realizamos el env�o del correo electr�nico con los archivos
	Correo correo = new Correo();
	correo.setAsunto("GENERACI�N AUTOM�TICO C�DIGOS PROMOCIONALES " + fechaActual.toString());
