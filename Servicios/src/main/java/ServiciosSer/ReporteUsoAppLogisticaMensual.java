...
public void generarUsoApp()
{
	...
	if(diaMaximoMesActual == diaAct)
	{
		...
		//Vamos a obtener los domiciliarios para con base en estos recorrer los días y saber la situación
...
//		}
		...
		String respuesta = "";
		respuesta = respuesta + "<table border='2'> <tr> REPORTE DE USO APP LOGÍSTICA POR TIENDA DE " + fechaAnterior + " A " + strFechaActual + " </tr>";
		...
		}else
		{
			...
			correo.setAsunto("USO APP LOGÍSTICA MENSUAL DEL " + fechaAnterior + " AL " + strFechaActual);
