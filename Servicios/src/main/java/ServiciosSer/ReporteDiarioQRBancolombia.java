...
public class ReporteDiarioQRBancolombia {
	        ...
	        
	{
		...
		//Realizamos la generaci�n de la informaci�n del detalle de los QR por todas las tiendas
		...
		correo.setMensaje("A continuaci�n el resumen de ventas QR Bancolombia para la fecha " + fechaActual +": \n" + respuesta);
