	        ...
	        
	{
		...
		for(Tienda tien : tiendas)
		{
			...
			if(!tien.getHostBD().equals(new String("")))
			{
				...
				//Realizamos validación si hay debe o no haber inserción para la tienda en cuestión.
				...
				if(!hayRegistros)
				{
					//Realizamos la inserción en la tabla temporal en el datamart
					for(capaModeloPOS.EmpleadoTemporalDia empTodos : empleadosTempTotal)
					{
						//Con cada uno realizamos inserción de la información EmpleadoTemporalDia
