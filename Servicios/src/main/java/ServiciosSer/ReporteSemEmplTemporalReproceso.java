...
/**
 * Reproceso del reporte semanal de personal temporal: igual a
 * ReporteSemEmplTemporal, pero con la fecha que traiga el parametro
 * FECHAREPROCESO en vez de la fecha del sistema.
 */
public class ReporteSemEmplTemporalReproceso {
	...
	public static void main(final String[] args) {
		...
		final Date datFechaAnterior = calendarioActual.getTime();
		final String fechaAnterior = dateFormat.format(datFechaAnterior);
