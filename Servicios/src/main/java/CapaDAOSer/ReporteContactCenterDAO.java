...
public class ReporteContactCenterDAO {
	...
	public static int obtenerCantidadPedidos(String fechaAnterior, String fechaActual)
	{
		...
		try
		{
			...
			cantidadPedidos = 0;
			System.out.println("falle lanzando la consulta estad�sticas pedidos contact center");
			try
			{
				con1.close();
			}catch(Exception e1)
	...
	/**
	 * M�todo que extrae la cantidad de pedidos tomados con origen CRM en un d�a particular
	 * @param fecha
	 * @return
	 */
	...
	/**
	 * M�todo que se encarga de traer los pedidos totales de tienda virtual para una fecha y una tienda determinada
	 * @param fecha
	 * @param idTienda
	 * @return
	 */
	...
	/**
	 * M�todo que se encarga de obtener el total de pedidos por canales no f�sicos para una tienda y una fechad determinado
	 * @param fecha
	 * @param idTienda
	 * @return
	 */
	...
	public static ArrayList obtenerPedidosDia(String fechaAnterior, String fechaActual)
	{
		...
		try
		{
			...
			System.out.println("falle lanzando la consulta estad�sticas pedidos contact center" + e.toString());
			try
			{
				con1.close();
			}catch(Exception e1)
	...
	/**
	 * Esta consulta nos trae la cantidad de pedidos por mes de los �ltimos meses(18 aproximadamente)
	 * @return
	 */
