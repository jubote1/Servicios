...
public class ReporteHorariosDAO {
	...
	/**
	 * M�todo creado en la reestructuraci�n de la forma de mostrar la informaci�n en donde se vuelve complejo retornarlo en un solo query
	 * y se hace necesario la devoluci�n de un arrayList con la informaci�n para procesarla y mostarla de la manera correcta.
	 * @param idTienda
	 * @param fecha
	 * @param bdGeneral
	 * @param auditoria
