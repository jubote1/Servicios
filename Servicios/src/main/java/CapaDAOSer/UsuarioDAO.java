 ...
 */
	...
	/**
	 * M�todo qeu se encargar� de retornar la toma de biometr�a de todos los empleados
	 * @return
	 */
...
// De aqui en adelante tendremos los temas para trabajar de manera LOCAL LA INSERCI�N Y BORRADO DE LAS TABLAS
	/**
	 * M�todo para clarear las tablas locales que ser�n sujeto de inserci�n
	 * @param hostBD
	 * @return
	 */
	...
	/**
	 * M�todo que se encarga de retornar un valor booleano indicando si el empleado determinado existe o no en la tabla de usuarios
	 * de la tienda, para saber si debe lanzar la creaci�n o una actualizaci�n.
	 * @param idUsuario
	 * @param hostBD
	 * @return
	 */
	...
	/**
	 * M�todo qeu se encarga de insertar un usuario en el sistema P�S
	 * @param empleado Se recibe un objeto de tipo usuario con la informaci�n del usuario que termina siendo un autor del sistema
	 * @return Se retorna un entero con id asignado por el sistema en la inserci�n.
	 */
	...
	/**
	 * M�todo qeu se encarga de actualizar un usuario en el sistema P�S
	 * @param empleado Se recibe un objeto de tipo usuario con la informaci�n del usuario que termina siendo un autor del sistema
	 * @return Se retorna un valor booleano que indica si se realiz� o no la actualizaci�n.
	 */
