...
public class InsumoAlertaDAO {
	...
	public static ArrayList<InsumoAlerta> retornarInsumosAlerta(String ipBodega)
	{
	...
	public static boolean insumoAlertaReportado(int idInsumo, int idTienda, String fechaApertura, String ipBodega)
	{
	...
	public static void insertarInsumoAlerta(int idInsumo, int idTienda, String fechaApertura, String ipBodega)
	{
		ConexionBaseDatos con = new ConexionBaseDatos();
		Connection con1 = con.obtenerConexionBDInventarioURL(ipBodega);
		try
