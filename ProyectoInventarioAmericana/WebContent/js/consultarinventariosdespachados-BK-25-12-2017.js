...
function consultarInventarioDespachado() 
{
	...
	$.ajax({ 
	    		...
	    		success: function(data1){ 
						...
						strInv += '<th COLSPAN="3"> <h2>'+ "PRODUCTOS A LLEVAR TIENDA " + tienda + " " + fechasurtir +'</h2></th></tr>'
						strInv += '<tr><th>Nom/Insumo</th><th>Cantidad a Surtir</th><th>Empaque</th><th>Unidad Medida</th></tr></thead>';
				        strInv += '<tbody>';
						for (var i = 0; i < inventarios.length; i++)
						{
							...
							strInv +='<td> <font size=1>';
							strInv +='<label>' + inventario.unidadmedida + '</label> </font> </td>';
							strInv +='</tr> ';
						}
						strInv +='</tbody> ';
