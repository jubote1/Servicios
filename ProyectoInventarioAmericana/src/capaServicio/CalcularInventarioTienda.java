 ...
 */
@WebServlet("/CalcularInventarioTienda")
public class CalcularInventarioTienda extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CalcularInventarioTienda() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String respuesta = inv.CalcularInventarioTienda(idtienda, fechasurtir);
