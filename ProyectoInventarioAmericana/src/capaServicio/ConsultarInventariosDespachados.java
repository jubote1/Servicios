 ...
 */
@WebServlet("/ConsultarInventariosDespachados")
public class ConsultarInventariosDespachados extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ConsultarInventariosDespachados() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String respuesta = inv.ConsultarInventariosDespachados(idtienda, fechasurtir);
