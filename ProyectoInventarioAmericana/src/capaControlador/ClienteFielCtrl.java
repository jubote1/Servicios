...
public class ClienteFielCtrl {
	...
	public void extraerClientesFieles()
	{
		...
		String rutaArchivoBD = ParametrosDAO.obtenerParametroTexto("RUTACLIFIEL");
		...
		try
		{
			String strDiasPedidos = ParametrosDAO.obtenerParametroTexto("DIASPEDIDO");
		...
		try
		{
			String strDiasNoPedidos = ParametrosDAO.obtenerParametroTexto("DIASNOPEDIDO");
		...
		try
		{
			String strDiasNoPedidosInferior = ParametrosDAO.obtenerParametroTexto("DIASNOPEDIDOINFERIOR");
		...
		try
		{
			String strCantidadPedidos = ParametrosDAO.obtenerParametroTexto("CANTIDADPEDIDOS");
...
{
	ClienteFielCtrl inventario = new ClienteFielCtrl();
